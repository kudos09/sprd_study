...
class getjsondata(object):
    def __init__(self, testpath1, testpath2):
        testpath1 = testpath1  #"test_report_tuning.json"
        testpath2 = testpath2  #"sharkL3_param_v0.json"
...
if __name__ == "__main__":
    ...
    getjsondata = getjsondata(testpath1, testpath2)

    inputdata, outputdata = getjsondata.GetLscData()
    adapt_lsc = tplm_lsc(inputdata, outputdata)
    adapt_lsc.getsolution()
    print("\n - - - -  enf LSC process - - - - \n")
